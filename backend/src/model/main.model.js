...
export const headers = {
  ...
  TILLCOM: {
    index: 2, // Starting index for TILLCOM (skipping header/subheader)
  ...
  CROPCOM: {
    index: 2, // Starting index for CROPCOM (skipping header/subheader)
  ...
  FERT2012: {
    index: 2, // Starting index for FERT2012 (skipping header/subheader)
  ...
  PESTCOM: {
    index: 2, // Starting index for PESTCOM (skipping header/subheader)
